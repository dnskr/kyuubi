...
of [Iceberg](https://iceberg.apache.org/). For the knowledge about Iceberg not
...
convenient, easy to understand, and easy to expand than directly using flink to
manipulate Iceberg.
...
3. `iceberg-flink-runtime-<flink.version>-<iceberg.version>.jar` (example:
   `iceberg-flink-runtime-1.20-1.7.0.jar`), which can be found in the
   [Maven Central](https://mvnrepository.com/artifact/org.apache.iceberg)
...
Taking `INSERT OVERWRITE` as an example:
