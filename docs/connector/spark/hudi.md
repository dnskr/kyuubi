...
this article, you can obtain it from its
...
easy to understand, and easy to expand than directly using Spark to manipulate
Hudi.

## Hudi Integration

To enable the integration of Kyuubi Spark SQL engine and Hudi through Spark
DataSource V2 API, you need to:

- Referencing the Hudi [dependencies](#spark-hudi-deps)
- Setting the Spark extension and catalog
  [configurations](#spark-hudi-conf)
