...
[TPC-H](https://www.tpc.org/tpch/). For the knowledge about TPC-H not mentioned
in this article, you can obtain it from its
[Official Documentation](https://www.tpc.org/tpch/).
```

This connector can be used to test the capabilities and query syntax of Spark
without configuring access to an external data source. When you query a TPC-H
...
To enable the integration of Kyuubi Spark SQL engine and TPC-H through Spark
...
3. `kyuubi-spark-connector-tpch-<release>_2.12.jar`, which can be found in the
   [Maven Central](https://repo1.maven.org/maven2/org/apache/kyuubi/kyuubi-spark-connector-tpch_2.12/)
