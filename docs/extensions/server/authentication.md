...
Besides the [builtin authentication](../../security/authentication.md) methods,
kyuubi supports custom authentication implementations of
`org.apache.kyuubi.service.authentication.PasswdAuthenticationProvider` and
...
To create custom Authenticator class derived from the above interface, we need
to:
...
- Implement PasswdAuthenticationProvider or TokenAuthenticationProvider -
  [Sample Code](https://github.com/kyuubilab/example-custom-authentication/blob/main/src/main/scala/org/apache/kyuubi/example/MyAuthenticationProvider.scala)
